...
input1 = input("    name file chate whatsapp ro bedone .txt vared konin: ")
input11 = input1+".txt"
input2 = input1+".html"


fileinput = codecs.open(input11, "r", "utf-8")
fileoutput = codecs.open(input2, "w", encoding="utf-8")

n = 0
fread = fileinput.readlines()
chat = " "
...
user2 = username2[0]
print()
bar = trange(r, bar_format="{l_bar}{bar}{n_fmt}/{total_fmt} [{elapsed}]")
for i in bar:
    ...
    if wo is True:
        ...
        {}
                ...
                '''.format(user1, c3[0], c3[1], c3[3], c5))
                ...
                {}
                        ...
                        '''.format(user2, c3[0], c3[1], c3[3], c5))
